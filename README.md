...
* Sessions allow the server to store information about a client and persist data so we know, for example, if a user is logged in.

1. What does bcrypt do to help us store passwords in a secure manner.
* bcrypt hashes the passwords.

1. What does bcrypt do to slow down attackers?
* bcrypt salts and hashes the passwords multiple times (rounds), making it more time-consuming for an attacker to crack a password
